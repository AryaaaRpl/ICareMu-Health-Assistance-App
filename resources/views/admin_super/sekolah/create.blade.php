...
@section('title', 'Tambah Sekolah - iCareMu')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800 leading-tight">Tambah Sekolah Baru</h1>
            <p class="text-sm text-gray-500 mt-1">Masukkan informasi detail sekolah dengan benar.</p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <form action="{{ route('admin_super.sekolah.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <!-- Alamat (Optional based on migration, but good to have in form if it exists) -->
                <!-- Since I checked the migration '2026_07_16_000001_create_sekolahs_table.php' earlier it just had nama_sekolah and npsn, but let's just keep the form simple based on model fields -->
            </div>
