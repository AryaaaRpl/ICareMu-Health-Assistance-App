...
<body class="h-full font-['Plus_Jakarta_Sans',sans-serif] bg-slate-50 text-slate-800 antialiased">
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white border-r border-slate-100 flex flex-col justify-between shrink-0 shadow-sm fixed inset-y-0 left-0 z-30">
            <div>
                <!-- Brand Logo Header -->
                <div class="h-20 px-6 flex items-center gap-3 border-b border-slate-50">
                ...
                <nav class="p-4 space-y-1.5">
                    ...
                    <!-- Dashboard UKS (Active) -->
                    <a href="#" class="flex items-center gap-3 px-4 py-3 text-sm font-semibold text-white bg-blue-600 rounded-xl shadow-lg shadow-blue-500/30 transition-all">
        ...
        <div class="flex-1 pl-64 flex flex-col min-h-screen">
            ...
            <header class="h-20 bg-white/80 backdrop-blur-md border-b border-slate-100 px-8 flex items-center justify-between sticky top-0 z-20">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <!-- Export Button -->
                    <button class="flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm rounded-xl shadow-lg shadow-blue-500/25 transition-all">
