    ...
    <div class="space-y-6">
        ...
        <form action="{{ route('login.post') }}" method="POST" class="space-y-4">
            ...
            <div class="space-y-1">
                ...
                <div class="relative">
                    <input type="text" name="credential" value="{{ old('credential') }}" placeholder="Masukkan NIS atau NIP Anda" required class="w-full pl-10 pr-4 py-3.5 rounded-2xl bg-slate-50 border border-slate-200 text-sm focus:outline-none focus:border-[#186EF9]">
            ...
            <div class="space-y-1">
                ...
                <div class="relative">
                    <input type="password" name="password" placeholder="Masukkan password Anda" required class="w-full pl-10 pr-4 py-3.5 rounded-2xl bg-slate-50 border border-slate-200 text-sm focus:outline-none focus:border-[#186EF9]">
                    <span class="absolute left-3.5 top-3.5 text-slate-400">🔒</span>
                </div>
            </div>
