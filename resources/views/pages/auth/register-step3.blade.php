<x-app.auth-layout title="Daftar Step 3 — iCareMu">
    <div class="space-y-6">
        ...
        <form action="{{ route('dashboard.siswa') }}" method="GET" class="space-y-6">
            <!-- Section 1: Data Wali -->
            <div class="space-y-3">
                ...
                <div class="space-y-3">
                    <input type="text" placeholder="Nama lengkap wali..." required class="w-full px-4 py-3.5 rounded-2xl bg-slate-50 border border-slate-200 text-sm focus:outline-none focus:border-[#186EF9]">
                    <input type="text" placeholder="No. WhatsApp Orang Tua (0812...)" required class="w-full px-4 py-3.5 rounded-2xl bg-slate-50 border border-slate-200 text-sm focus:outline-none focus:border-[#186EF9]">
                </div>
            </div>
            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="relative">
                        <input type="number" placeholder="Tinggi (cm)" required class="w-full px-4 py-3.5 rounded-2xl bg-slate-50 border border-slate-200 text-sm focus:outline-none focus:border-[#186EF9]">
                    </div>
                    <div class="relative">
                        <input type="number" placeholder="Berat (kg)" required class="w-full px-4 py-3.5 rounded-2xl bg-slate-50 border border-slate-200 text-sm focus:outline-none focus:border-[#186EF9]">
                    </div>
                </div>
                <select class="w-full px-4 py-3.5 rounded-2xl bg-slate-50 border border-slate-200 text-sm font-medium text-slate-700 focus:outline-none focus:border-[#186EF9]">
                    <option>Golongan Darah (Pilih)...</option>
                    <option>Golongan Darah A</option>
                    <option>Golongan Darah B</option>
                    <option>Golongan Darah AB</option>
                    <option>Golongan Darah O</option>
                </select>
            </div>
